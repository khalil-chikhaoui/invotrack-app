  ...
  return (
    <div className="min-h-[300px]">
      {selectedList.length > 0 ? (
        <div className="bg-white dark:bg-gray-900 rounded-3xl border border-gray-200 dark:border-white/5 overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
          {/* --- HEADER --- */}
          <div className="px-6 py-4 border-b border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-white/[0.02] flex justify-between items-center">
            <h3 className="text-sm font-medium  tracking-widest text-gray-700 dark:text-gray-300">
                  ...
                  <div
                    ...
                    ${
                      item.deliveryStatus === "Shipped"
                        ...
                        : "bg-gray-50 dark:bg-white/[0.05] text-gray-600 group-hover:bg-brand-50 group-hover:text-brand-500 dark:group-hover:bg-brand-500/20 dark:group-hover:text-brand-400"
                    }`}
                  >
                    {item.deliveryStatus === "Shipped" ? (
                ...
                <div className="flex items-center gap-6">
                  ...
                  {item.deliveryStatus !== "Shipped" && (
                    <button
                      ...
                      className="p-2 text-gray-500 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-lg transition-all"
          ...
          <div className="bg-gray-50/50 dark:bg-white/[0.02] border-t border-gray-100 dark:border-white/5 p-4 px-6 flex justify-between items-center">
            <span className="text-sm font-medium  tracking-widest text-gray-700 dark:text-gray-300">
