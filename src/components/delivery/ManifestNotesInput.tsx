  ...
  return (
    <div className="lg:w-80 space-y-4">
      <div className="relative">
        <label className="text-[10px] font-bold uppercase tracking-widest text-gray-700 dark:text-gray-300 mb-1.5 block px-1">
          {t("form.notes_label")}
        </label>
        <textarea
          value={manifestNotes}
          ...
          className="w-full h-24 rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/50 px-4 py-3 text-sm font-medium outline-none focus:border-brand-500 transition-all dark:text-white placeholder:text-gray-500 placeholder:font-light dark:placeholder:text-gray-300 resize-none"
        />
