  ...
  return (
    <div className="flex items-center justify-between mb-8">
      <button
        ...
        className="flex items-center mt-4 gap-2 text-[10px] font-semibold uppercase text-gray-700 
        hover:text-brand-500 dark:text-gray-300 hover:dark:text-brand-400 transition-colors tracking-widest cursor-pointer"
      >
