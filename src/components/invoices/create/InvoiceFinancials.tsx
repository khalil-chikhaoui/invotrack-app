...
export default function InvoiceFinancials({ 
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-gray-200/60 dark:border-white/10 bg-white/40 dark:bg-gray-900/40 backdrop-blur-md transition-all duration-300">
      <div className="flex items-center gap-3 px-5 py-3 border-b border-gray-100/50 dark:border-white/5">
        <HiOutlineCalculator className="text-gray-500 dark:text-gray-400 size-5" />
      ...
      <div className="p-5 space-y-5">
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 rounded-xl text-[10px] font-bold uppercase transition-all border ${
                  discountType === "percentage"
                    ...
                    : "bg-transparent border-gray-300 dark:border-gray-600 text-gray-600 hover:text-brand-500"
                }`}
              >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
          ...
          <div className="space-y-2">
            <Label className="text-[10px] uppercase font-bold text-gray-600 dark:text-gray-300 tracking-widest pl-1">
            ...
            <div className="relative group flex items-center">
              <div className="absolute left-0 top-0 bottom-0 w-10 flex items-center justify-center border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900/40 rounded-l-xl z-10">
                <HiOutlineReceiptTax className="text-gray-500 size-4" />
              </div>
              <NumericInput
                variant="quantity"
                value={taxRate}
          ...
          <div className="space-y-2">
            ...
            <div className="relative group flex items-center">
              <div className="absolute left-0 top-0 bottom-0 w-10 flex items-center justify-center border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900/40 rounded-l-xl z-10">
                <HiOutlineTruck className="text-gray-500 size-4" />
              </div>
              <NumericInput
                variant="currency"
                value={deliveryFee}
