...
export default function InvoiceNotes({
  ...
  return (
    <div className="p-4  rounded-md border border-gray-200 dark:border-white/5">
      ...
      <textarea
        className="w-full h-[100px] rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/50 px-2 py-3 text-sm font-medium outline-none focus:border-brand-500 transition-all dark:text-white  placeholder:text-gray-500 placeholder:font-light dark:placeholder:text-gray-300"
