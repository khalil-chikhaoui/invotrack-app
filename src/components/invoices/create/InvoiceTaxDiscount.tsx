/**
 * @fileoverview InvoiceTaxDiscount Component
 * Handles the input for tax rates and discount values with toggleable modes.
 */

import { useTranslation } from "react-i18next";
import { HiOutlineCalculator, HiReceiptPercent, HiTag } from "react-icons/hi2";
      ...
      <div className="p-5 space-y-5">
          ...
          <div className="space-y-2 sm:col-span-4">
            ...
            <div className="relative group">
              <NumericInput
                ...
                placeholder="0.00"
                className="w-full bg-transparent border border-gray-300 dark:border-gray-600 rounded-xl px-3 py-2 text-sm font-semibold text-gray-800 dark:text-white transition-all focus:ring-1 focus:ring-brand-500 focus:border-brand-500 hover:border-gray-400 dark:hover:border-gray-500"
              />
            </div>
          </div>
          ...
          <div className="space-y-2 sm:col-span-8">
            ...
            <div className="flex gap-2 h-11">
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 rounded-xl text-[10px] font-bold uppercase tracking-wider transition-all duration-200 border ${
                  discountType === "percentage"
                    ? "bg-brand-500 border-brand-500 text-white shadow-sm"
                    : "bg-transparent border-gray-300 dark:border-gray-600 text-gray-500 dark:text-gray-400 hover:border-brand-400 hover:text-brand-500"
                }`}
              >
                <HiReceiptPercent className="size-4" />
                <span>{t("create.sections.percentage")}</span>
              </button>
        ...
        <div className="pt-2">
          ...
          <div className="relative group flex items-center">
            {/* UI Fix: Adjusted border to border-r for the icon container */}
            ...
            <NumericInput
              ...
              placeholder="0"
              className="w-full bg-white dark:bg-gray-900/40 border border-gray-200 dark:border-gray-700 rounded-xl py-2.5 pr-3 pl-12 text-sm font-bold text-gray-800 dark:text-white shadow-sm transition-all focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 group-hover:border-brand-300 dark:group-hover:border-brand-700"
            />
