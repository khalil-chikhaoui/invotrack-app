...
// FIX: Extend HTMLAttributes to allow onClick, onHover, etc.
...
//  FIX: Capture '...props' and pass them to the <tr> element
...
const TableCell: React.FC<TableCellProps> = ({
  ...
  return (
    // @ts-ignore - Dynamic tag types can be tricky in TS, ignoring strictly for the tag type mismatch between th/td
