...
export default function ItemFormModal({
        ...
        <React.Fragment key={s}>
          ...
          {i < 2 && (
            <div className="flex-1 h-[1px] bg-gray-200 dark:bg-gray-700 mx-2 relative">
              <div className="absolute left-0 top-0 h-full bg-brand-500 transition-all duration-500 ease-out" style={{ width: step > s ? "100%" : "0%" }} />
            </div>
          )}
        </React.Fragment>
      ))}
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} className="max-w-[600px] w-full mx-4">
