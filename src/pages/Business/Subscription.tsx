    ...
    <>
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 relative overflow-hidden rounded-3xl bg-brand-600 p-8 text-white">
          ...
          {/* Payment Method Card */}
          <div className="rounded-3xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-white/[0.05] p-8 flex flex-col justify-between">
            <div>
              <h3 className="text-[10px] font-semibold text-gray-500 uppercase tracking-widest mb-6 flex items-center gap-2">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Expiry 12/28</p>
                </div>
              </div>
            </div>
            <Button 
        ...
        <div>
          <div className="flex flex-col md:flex-row justify-between items-end mb-6">
            ...
            {/* Frequency Toggle */}
            <div className="flex bg-gray-100 dark:bg-gray-800 p-1 rounded-xl mt-4 md:mt-0">
              <button
                onClick={() => setBillingCycle("monthly")}
                className={`px-4 py-1.5 rounded-lg text-xs font-semibold transition-all ${billingCycle === "monthly" ? "bg-white dark:bg-gray-700 text-gray-900 dark:text-white" : "text-gray-600 hover:text-gray-900 dark:hover:text-white"}`}
              >
                Monthly
              </button>
              <button
                onClick={() => setBillingCycle("yearly")}
                className={`px-4 py-1.5 rounded-lg text-xs font-semibold transition-all ${billingCycle === "yearly" ? "bg-white dark:bg-gray-700 text-gray-900 dark:text-white" : "text-gray-600 hover:text-gray-900 dark:hover:text-white"}`}
              >
                Yearly{" "}
            ...
            {PLANS.map((plan) => (
              <div
                ...
                className={`relative p-6 rounded-3xl border transition-all duration-300 ${
                  plan.current
                    ? "bg-white dark:bg-gray-900 border-brand-500 ring-4 ring-brand-500/10 scale-[1.02] z-10"
                    : "bg-white dark:bg-white/[0.02] border-gray-200 dark:border-white/[0.05] hover:border-brand-200 dark:hover:border-white/10"
                }`}
              >
                {plan.popular && (
                  <div className="absolute top-0 right-0 bg-brand-500 text-white text-[9px] font-semibold uppercase tracking-widest px-3 py-1 rounded-bl-xl rounded-tr-2xl">
                    Most Popular
                  </div>
                )}

                <h4 className="text-sm font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-widest mb-2">
                  {plan.name}
                </h4>
                ...
                <Button
                  ...
                  className="w-full text-[10px] font-semibold uppercase tracking-widest py-3"
        ...
        {/* --- 3. BILLING HISTORY --- */}
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-white/[0.05] rounded-3xl overflow-hidden">
          <div className="p-6 border-b border-gray-100 dark:border-white/5 flex justify-between items-center bg-gray-50/30 dark:bg-transparent">
            <h3 className="text-[10px] font-semibold text-gray-500 uppercase tracking-widest flex items-center gap-2">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              <thead>
                <tr className="bg-gray-50/50 dark:bg-white/[0.02] text-[9px] font-semibold uppercase tracking-widest text-gray-500 border-b border-gray-100 dark:border-white/5">
